...
namespace QLConTy_Entity.DuAn
{
    ...
    {        
        ...
        private void fQLDuAn_Load(object sender, EventArgs e)
        {
            ...
            //gvPCDuAn.DataSource = daDao.LayDanhSach($"select MaDA, MaNV, CongViec, NgayBD, NgayKT, TienDo from PHANCONGDUAN where MaDA = '{txtMaDA}'");
            DoiTen();
        }
        ...
        {
            PHANCONGDUAN pcnl = new PHANCONGDUAN(txtMaDA.Text, txtMaNV.Text, cboCongViec.Text, dtpStart.Value.Date, dtpFinish.Value.Date);
