...
namespace QLCongTy
{
    public partial class FProfile : Form
    {
        ...
        private void btnThongTinCaNhan_Click(object sender, EventArgs e)
        {
            ...
            lblNgaySinh.Text = Convert.ToString(fMainMenu.currentStaff.NgaySinh);
            lblSDT.Text = fMainMenu.currentStaff.SDT;
            lblGioiTinh.Text = fMainMenu.currentStaff.GioiTinh;
            lblEmail.Text = fMainMenu.currentStaff.Email;
            lblCCCD.Text = fMainMenu.currentStaff.CCCD;
            lblDiaChi.Text = fMainMenu.currentStaff.DiaChi;
            ShowPanel();
        }
        ...
        private void btnDuAn_Click(object sender, EventArgs e)
        {
            ...
            gvDuAn.DataSource = profileDao.GetDuAn(fMainMenu.currentStaff);
            ShowPanel();
        }
        ...
        private void btnBaoMat_Click(object sender, EventArgs e)
        {
            ...
            lblMatKhau.Text = profileDao.GetMatKhau(fMainMenu.currentStaff);
            ShowPanel();
        }
        ...
        {
            pnlDoiMatKhau.Visible = false;
            profileDao.DoiMatKhau(fMainMenu.currentStaff,txtMatKhauCu.Text, txtMatKhauMoi.Text);
            lblMatKhau.Text = profileDao.GetMatKhau(fMainMenu.currentStaff);
        }
